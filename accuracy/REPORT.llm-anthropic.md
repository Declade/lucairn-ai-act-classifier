...
| Metric | Score |
|---|---|
| **Overall accuracy** (granular per-field pass rate) | **97.6%** |
...
| `fixture-day7-06-annex-admission-en` | en | annex_iii | FAIL | annex_iii.sub_letters |
...
| `fixture-day7-13-annex-polygraph-en` | en | annex_iii | FAIL | annex_iii.sub_letters |
...
| `fixture-day7-20-art5-social-scoring-en` | en | article_5 | FAIL | annex_iii.domains |
...
### `fixture-day7-06-annex-admission-en` (en, bucket: annex_iii)

| Field | Expected | Actual |
|---|---|---|
| `annex_iii.sub_letters` | `{"3":["a"]}` | `{"3":[]}` |

### `fixture-day7-13-annex-polygraph-en` (en, bucket: annex_iii)

| Field | Expected | Actual |
|---|---|---|
| `annex_iii.sub_letters` | `{"6":["b"]}` | `{"6":["b","c"]}` |

### `fixture-day7-20-art5-social-scoring-en` (en, bucket: article_5)
