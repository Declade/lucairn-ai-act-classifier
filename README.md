...
The classifier is benchmarked against a 71-case bilingual fixture corpus (CC-BY-4.0): 50 day{3,4,5,7} fixtures + 9 v0.1.3 + 3 v0.1.4 + 4 v0.2.0 + 5 v0.3.0 launch-feedback fixtures; ~34 EN + ~37 DE across 5 buckets (annex_iii / article_5 / article_50 / negative / legacy). Current numbers on the v0.3.0 rule-set:

- **Overall accuracy:** 98.8 % (granular per-field pass rate; up from 98.7 % in v0.2.0, 98.6 % in v0.1.4, 98.5 % in v0.1.3, 98.2 % in v0.1.2)
- **Article 5 prohibition** (safety-critical): 100.0 %
- **Binary high-risk classification:** 98.6 %
