...
describe('formatMarkdown() — output shape', () => {
  it('EN snapshot — high-risk fixture, cite: false', () => {
  ...
  it('DE snapshot — high-risk fixture, cite: false', () => {
  ...
  it('--cite toggle adds the Citations section', () => {
  ...
  it('--no-three-category toggle removes the Lucairn overlay table', () => {
    const r = classify('We use AI for CV screening.', { lang: 'en', threeCategory: false });
  ...
  it('disclaimer footer present in every variant', () => {
    const r = classify('We use AI for CV screening.', { lang: 'en' });
